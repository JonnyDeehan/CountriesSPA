...
var GridHeaderComp = () => {
  ...
  const setRef2 = (0, import_react10.useCallback)((e) => {
    ...
    gridCtrlRef.current = context.createBean(new import_core9.GridHeaderCtrl());
...
var CellEditorComponentProxy = class {
  constructor(cellEditorParams, refreshProps) {
    ...
    this.refreshProps = refreshProps;
    this.instanceCreated = new import_core17.AgPromise((resolve) => {
      this.resolveInstanceCreated = resolve;
    });
      ...
      const addComp = (comp) => {
        if (comp) {
          ...
          cellWrapperDestroyFuncs.current.push(() => {
            context.destroyBean(comp);
            (0, import_core16._removeFromParent)(eGui2);
          });
        }
        return comp;
      };
...
var RowComp = (params) => {
  ...
  if (!cssClassManager.current) {
    cssClassManager.current = new import_core15.CssClassManager(() => eGui.current);
  }
...
var RowContainerComp = (params) => {
  ...
  const { name } = params;
  const containerOptions = (0, import_react17.useMemo)(() => (0, import_core14._getRowContainerOptions)(name), [name]);
...
var GridBodyComp = () => {
  ...
  const setRef2 = (0, import_react9.useCallback)((e) => {
    ...
    addComp(eRoot.current, import_core8.FakeHScrollComp, " AG Fake Horizontal Scroll ");
    addComp(eRoot.current, import_core8.OverlayWrapperComponent, " AG Overlay Wrapper ");
    if (eBody.current) {
...
var TabGuardCompRef = (props, forwardRef4) => {
  ...
  const setupCtrl = (0, import_react23.useCallback)(() => {
    ...
    if (topTabGuardRef.current && bottomTabGuardRef.current) {
      ...
      tabGuardCtrlRef.current = context.createBean(
        new import_core18.TabGuardCtrl({
          comp: compProxy,
  ...
  const createTabGuard = (side) => {
    const className = side === "top" ? import_core18.TabGuardClassNames.TAB_GUARD_TOP : import_core18.TabGuardClassNames.TAB_GUARD_BOTTOM;
    return /* @__PURE__ */ import_react23.default.createElement(
      "div",
      {
        className: `${import_core18.TabGuardClassNames.TAB_GUARD} ${className}`,
        role: "presentation",
...
var GridComp = ({ context }) => {
  ...
  const setRef2 = (0, import_react8.useCallback)((e) => {
    ...
    gridCtrlRef.current = context.createBean(new import_core7.GridCtrl());
